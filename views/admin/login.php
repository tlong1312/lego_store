          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="public/admin/index.html" class="app-brand-link gap-2">
              ...
              <form id="formAuthentication" class="mb-3" action="index.html" method="POST">
                ...
                <div class="mb-3 form-password-toggle">
                  <div class="d-flex justify-content-between">
                    ...
                    <a href="public/admin/auth-forgot-password-basic.html">
              ...
              <p class="text-center">
                ...
                <a href="public/admin/auth-register-basic.html">
